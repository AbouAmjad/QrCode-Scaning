...
const ROLE_META = {
  ...
  safety: {
    department: "Safety",
    title: "Safety",
    summary: "Damage reports · forms · read-only timesheet"
  },
  store_manager: {
    department: "Warehouse",
    title: "Store Manager",
  ...
  material_controller: {
    department: "Warehouse / Materials",
    title: "Material Controller",
    summary: "Materials control · stock · receiving · inventory · checkout"
  },
  coo: {
  ...
  ceo: {
    ...
    title: "CEO",
    summary: "Executive visibility · reports · operations overview"
  },
  accountant: {
    department: "Finance",
    title: "Accountant",
    summary: "Reports · inventory visibility · read-only timesheet"
  },
  hr: {
    department: "Human Resources",
    title: "HR",
    summary: "People records · forms · read-only timesheet"
  },
  project_manager: {
    department: "Projects",
...
const DEFAULT_ROLE_PERMISSIONS = {
  ...
  safety: [
    "dashboard.view", "tool.view", "worker.view",
    "damage.create", "damage.review", "forms.view",
    "timesheet.attendance.read", "timesheet.reports.read", "timesheet.notifications.read"
  ],
  store_manager: [
    "dashboard.view", "terminal.use",
    "tool.view", "tool.create", "tool.edit", "tool.delete", "tool.checkout", "tool.return", "tool.receive", "tool.search",
    "worker.view", "worker.create", "worker.edit", "worker.delete",
    "inventory.view", "inventory.count", "inventory.adjust", "inventory.transfer",
    "damage.create", "damage.review", "consumables.manage", "request.approve",
    "forms.view", "reports.warehouse", "logs.view",
  ...
  material_controller: [
    "dashboard.view", "terminal.use",
    "tool.view", "tool.create", "tool.edit", "tool.checkout", "tool.return", "tool.receive", "tool.search",
    "worker.view",
    "inventory.view", "inventory.count", "inventory.adjust", "inventory.transfer",
    "damage.create", "damage.review", "consumables.manage", "request.approve",
    "forms.view", "reports.warehouse", "logs.view",
  ...
  ceo: [
    "dashboard.view", "dashboard.full",
    "tool.view", "worker.view", "inventory.view",
    "damage.review", "damage.approve",
    "forms.view", "reports.warehouse", "reports.team", "reports.all", "logs.view",
    "projects.view", "qc.view",
    "timesheet.attendance.read", "timesheet.reports.read", "timesheet.notifications.read"
  ],
  accountant: [
    "dashboard.view", "tool.view", "worker.view", "inventory.view",
    "damage.review", "forms.view",
    "reports.warehouse", "reports.team", "reports.all",
    "projects.view",
    "timesheet.attendance.read", "timesheet.reports.read", "timesheet.notifications.read"
  ],
  hr: [
...
const ROLE_PERMISSIONS = {
  ...
  material_controller: DEFAULT_ROLE_PERMISSIONS.material_controller,
  coo: DEFAULT_ROLE_PERMISSIONS.coo,
  ceo: DEFAULT_ROLE_PERMISSIONS.ceo,
  accountant: DEFAULT_ROLE_PERMISSIONS.accountant,
  hr: DEFAULT_ROLE_PERMISSIONS.hr,
...
const EDITABLE_ROLES = ["employee", "supervisor", "viewer", "safety", "store_manager", "material_controller", "coo", "ceo", "accountant", "hr", "project_manager", "project_engineer", "logistics", "engineer", "qc", "worker"];
const ALL_ROLES = ["admin", "employee", "supervisor", "viewer", "safety", "store_manager", "material_controller", "coo", "ceo", "accountant", "hr", "project_manager", "project_engineer", "logistics", "engineer", "qc", "worker"];
...
async function seedPermissions(query, opts = {}) {
  ...
  if (opts.resetRoles === true) {
    ...
    if (existing.rows[0].n === 0) {
      ...
      for (const role of ["supervisor", "viewer", "safety", "store_manager", "material_controller", "coo", "ceo", "accountant", "hr", "project_manager", "project_engineer"]) {
...
/** Like normalizeRoleLocal, but unknown/empty → "" (never invent employee). */
