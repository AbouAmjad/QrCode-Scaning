...
const AppConfig = {
  ...
  ROLES: ["employee", "storekeeper", "supervisor", "viewer", "safety", "logistics", "engineer", "qc", "admin", "worker"],
  ROLE_RANK: { worker: 0, viewer: 1, storekeeper: 1, employee: 1, safety: 2, logistics: 2, engineer: 2, supervisor: 2, qc: 2, admin: 3 },
  ROLE_HOME: {
    employee: "index.html",
