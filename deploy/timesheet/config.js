...
const AppConfig = {
  ...
  ROLES: ["employee", "storekeeper", "supervisor", "viewer", "safety", "store_manager", "coo", "ceo", "accountant", "project_manager", "project_engineer", "logistics", "engineer", "qc", "admin", "worker"],
  ROLE_RANK: { worker: 0, viewer: 1, storekeeper: 1, employee: 1, safety: 2, store_manager: 2, coo: 2, project_manager: 2, project_engineer: 2, logistics: 2, engineer: 2, supervisor: 2, qc: 2, accountant: 2, ceo: 3, admin: 3 },
  ROLE_HOME: {
    employee: "index.html",
