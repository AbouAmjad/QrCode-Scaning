...
const TCUI = (() => {
  const PAGE_META = [
    ...
    { id: "requests", href: "requests.html", icon: "bi-clipboard-check", i18n: "requests", group: "store" },
    ...
    { id: "projects", href: "warehouses.html#projects", icon: "bi-buildings", i18n: "projects", group: "warehouse" },
