...
const TCUI = (() => {
  const PAGE_META = [
    ...
    { id: "categories", href: "categories.html", icon: "bi-tags-fill", i18n: "categoriesTab", group: "catalog" },
    ...
    { id: "requests", href: "requests.html", icon: "bi-cart3", i18n: "requests", group: "store" },
    { id: "forms", href: "forms.html", icon: "bi-file-earmark-text", i18n: "forms", group: "store" },
    { id: "repair", href: "repair.html", icon: "bi-wrench-adjustable", i18n: "repair", group: "store" },
