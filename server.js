...
const timesheetFeatures = require("./handlers/timesheet_features");
...
const ACTIONS = {
  ...
  resetRolePermissions: auth.resetRolePermissions,
  ...
  reorderCatalogNodes: catalog.reorderCatalogNodes,
  ...
  /* timesheet */
  timesheetGetSettings: timesheet.timesheetGetSettings,
  timesheetSetSettings: timesheet.timesheetSetSettings,
  timesheetPunch: timesheet.timesheetPunch,
  timesheetListAttendance: timesheet.timesheetListAttendance,
  timesheetVoidAttendance: timesheet.timesheetVoidAttendance,
  timesheetAdjustHours: timesheet.timesheetAdjustHours,
  timesheetListHourAdjustments: timesheet.timesheetListHourAdjustments,
  timesheetVoidHourAdjustment: timesheet.timesheetVoidHourAdjustment,
  timesheetCreateDeduction: timesheet.timesheetCreateDeduction,
  timesheetListDeductions: timesheet.timesheetListDeductions,
  timesheetVoidDeduction: timesheet.timesheetVoidDeduction,
  timesheetLinkWorkerAccount: timesheet.timesheetLinkWorkerAccount,
  timesheetUnlinkWorkerAccount: timesheet.timesheetUnlinkWorkerAccount,
  timesheetListWorkerAccounts: timesheet.timesheetListWorkerAccounts,
  timesheetListWorkers: timesheet.timesheetListWorkers,
  timesheetUpsertWorker: timesheet.timesheetUpsertWorker,
  timesheetSetWorkerActive: timesheet.timesheetSetWorkerActive,
  timesheetMySummary: timesheet.timesheetMySummary,
  timesheetMyAttendance: timesheet.timesheetMyAttendance,
  timesheetMyHours: timesheet.timesheetMyHours,
  timesheetMyDeductions: timesheet.timesheetMyDeductions,
  /* timesheet features (additive) */
  timesheetDashboardStats: timesheetFeatures.timesheetDashboardStats,
  timesheetChartSeries: timesheetFeatures.timesheetChartSeries,
  timesheetProjectSummary: timesheetFeatures.timesheetProjectSummary,
  timesheetReportSummary: timesheetFeatures.timesheetReportSummary,
  timesheetActivityList: timesheetFeatures.timesheetActivityList,
  timesheetNotificationsList: timesheetFeatures.timesheetNotificationsList,
...
const PUBLIC_ACTIONS = new Set(["login", "registerUser", "options", "weddingRsvpStats", "weddingRsvpSubmit"]);
